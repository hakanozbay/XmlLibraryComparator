...
public class TubeLinesParserTests {
	...
	public void setUp() throws Exception {
		...
		xstream.processAnnotations(TubeLines.class);
		xstream.processAnnotations(TubeLine.class);
		xstream.processAnnotations(Station.class);
		
		_tubeLines= (TubeLines) xstream.fromXML (new File(ClassLoader.getSystemResource("TubeLines.xml").toURI()));
	}
